...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBtn_0!!.text = "to-->Main3"
        mBtn_1!!.text = "to-->Main4"

        mBtn_0!!.setOnClickListener { startActivity(Intent(this, Main3Activity::class.java)) }
        mBtn_1!!.setOnClickListener { startActivity(Intent(this, Main4Activity::class.java)) }
