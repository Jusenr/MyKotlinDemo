...
import com.putao.mykotlindemo.R;
import com.putao.mykotlindemo.base.eventbus.EventBusHelper;
import com.putao.mykotlindemo.base.handler.WeakHandler;
import com.putao.mykotlindemo.utils.DiskFileCacheHelper;
import com.putao.mykotlindemo.utils.Logger;
import com.putao.mykotlindemo.utils.NetworkUtils;
import com.putao.mykotlindemo.utils.ToastUtils;
 ...
 */
public abstract class BasicFragmentActivity<App extends TotalApplication> extends AppCompatActivity {
    ...
    protected final void onCreate(Bundle savedInstanceState) {
       ...
       MyActivityManager.getInstance().addActivity(this);//添加当前Activity到管理堆栈
        //监听Home键
    ...
    @Override
    public void finish() {
        MyActivityManager.getInstance().removeCurrentActivity();
        super.finish();
    }
    ...
    protected void addFragment(Class<? extends Fragment> targetClass, Bundle args) {
        ...
        getSupportFragmentManager().beginTransaction().add(R.id.fragment_container, Fragment.instantiate(mContext, fragmentName, args), fragmentName).commit();
    }
    ...
    protected boolean exit(long exit) {
        if (System.currentTimeMillis() - exitTime > exit) {
            ...
            MyActivityManager.getInstance().killProcess(mContext.getApplicationContext());
        }
        return true;
    }
