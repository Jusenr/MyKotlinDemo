 ...
 * @author mrsimple
 */
public final class EventBusType {
    /**
     * 默认的tag
     */
     ...
     * @param aClass
     */
    public EventBusType(Class<?> aClass) {
        this(aClass, DEFAULT_TAG);
    }

    public EventBusType(Class<?> aClass, String aTag) {
        paramClass = aClass;
        tag = aTag;
    }
    ...
    public String toString() {
        return "EventBusType [paramClass=" + paramClass.getName() + ", tag=" + tag + "]";
    }
