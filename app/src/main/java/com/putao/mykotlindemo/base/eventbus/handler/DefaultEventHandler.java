...
public class DefaultEventHandler implements EventHandler {
     ...
     * @param event
     */
    public void handleEvent(EventBusSubscription eventBusSubscription, Object event) {
        if (eventBusSubscription == null
                || eventBusSubscription.subscriber == null) {
            return;
        }
        try {
            // 执行
            eventBusSubscription.targetMethod.invoke(eventBusSubscription.subscriber, event);
